 ...
 * Recipient's email ID needs to be mentioned. String to = "abcd@gmail.com";
 * 
 ...
 * 
 * // Send message Transport.send(message); System.out.println(
 * "Sent message successfully...."); }catch (MessagingException mex) {
 * mex.printStackTrace(); } } }
 */