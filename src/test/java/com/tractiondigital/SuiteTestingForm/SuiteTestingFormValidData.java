...
public class SuiteTestingFormValidData extends SuiteTestingFormBase {
	...
	@Test(dataProvider = "TestDataToRun_Test", description = "This Class is used to Verify SuiteTestingForm Valid Data")
	public void SuiteTestingFormValidDataTest(String FirstName, String LastName, String Email, String MobileNo,
		...
		try {
			...
			verifyTestingFormConfirmation("Thank you for entering the competition.");
